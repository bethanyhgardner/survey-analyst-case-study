...
Use the {simr} package to simulate data and estimate the power for each effect at 108, 132, 156, and 180 participants.
...
-   We determined that 156 participants, each completing 30 trials, would have 0.93 [0.91, 0.94] power at α = .05 to detect the two-way interactions (Pronoun &times; Nametag/ Introduction).
