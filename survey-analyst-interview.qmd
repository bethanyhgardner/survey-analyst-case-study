...
::: incremental
-   Before we can/should use the survey questions as predictors of production accuracy, we need to establish the internal reliability [@hedge2017]
-   Used a Bayesian mixed-effects model approach comparing the by-participant slopes in each half of the data [@staub2021]
...
Fit using the {brms} package [@bürkner2017] in R:
...
-   The maximal model justified by the experimental design: `Accuracy ~ Pronoun * Nametag * Intro + (Pronoun | ParticipantID) + (1 | Character)` [@baayen2008; @barr2013].
...
-   Using {lme4} for logistic mixed-effects regression modeling [@bates2015] and {buildmer} for stepwise model comparison [@voeten2023]
...
##  {#results-survey data-menu-title="Results: Prior Familiarity & Attitudes"}

![](images/fig-exp3-survey-1.png){fig-align="center"}

##  {#results-distribution data-menu-title="Results: Distribution"}

![](images/fig-exp3-dist-1.png){fig-align="center"}

##  {#results-accuracy data-menu-title="Results: Accuracy"}

![](images/fig-exp3-acc-1.png){fig-align="center"}

##  {#results-means data-menu-title="Results: Condition Means"}

![](images/fig-exp3-conds-1.png){fig-align="center"}

##  {#results-correlations data-menu-title="Results: Correlations"}

![](images/fig-exp3-corr-1.png){fig-align="center"}

##  {#results-gender-beliefs data-menu-title="Results: Gender Beliefs"}

![](images/fig-exp3-gender-beliefs-1.png){fig-align="center"}

## Demographics Questions {.scrollable}

Age: \_\_\_\_\_\_\_\_\_\_\_

<br>

What is your gender? \_\_\_\_\_\_\_\_\_\_\_
...
\[ \] I use a different term: \_\_\_\_\_\_\_\_\_\_\_
...
## Survey Questions: Naturalness Ratings {.scrollable}

Likert scale with 1 = “very unnatural” and 7 = “very natural”. Subset of items from [@conrod2019]:
...
## Survey Questions: Prior Familiarity {.scrollable}

Some people use they/them pronouns instead of he/him or she/her pronouns. An example of this is “Alex raised their hand.” How familiar are you with this? (select all that apply)
...
## Survey Questions: Gender Beliefs {.scrollable}

Transphobia Scale from [@nagoshi2008]. Likert scale with 1 = "Completely Disagree" and 7 = "Completely Agree":
...
5.    I believe that the male/female dichotomy is natural.
6.    I am uncomfortable around people who don’t conform to traditional gender roles, e.g., aggressive women or emotional men.
7.    I believe that a person can never change their gender.
8.    A person’s genitalia define what gender they are, e.g., a penis defines a person as being a man, a vagina defines a person as being a woman.
